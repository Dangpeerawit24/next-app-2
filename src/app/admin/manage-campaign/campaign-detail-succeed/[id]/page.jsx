...
export default function CampaignDetail() {
  ...
  // ✅ ดึงข้อมูลสมาชิก
  useSSE(`/api/campaign-transactions/succeed?id=${id}`, (data) => {
    setCampaigns(data);
    setLoading(false);
  });
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600">รายการที่ยังไม่ดำเนินการ</button>
          </div>
          <div>
            <button
